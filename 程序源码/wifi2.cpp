...
int show_count_2_2=1;
int show_count_4_4=1;

wifi2::wifi2(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::wifi2)
{
    ui->setupUi(this);
...
void wifi2::closeEvent(QCloseEvent *event)
{
...
void wifi2::on_pushButton_3_clicked()
{
    if(show_count_2_2%2 == 1)
...
void wifi2::on_pushButton_4_clicked()
{
    if(show_count_4_4%2 == 1)
...
void wifi2::on_pushButton_clicked()
{
    widget->hide();
    ui->lineEdit->clear();          //清空链接对话框里面的内容
    ui->lineEdit_2->clear();
...
void wifi2::on_pushButton_2_clicked()
{
    int a;
    a=link();
    widget->hide();
