...
computer1::computer1(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::computer1)
{
    ui->setupUi(this);
...
void computer1::closeEvent(QCloseEvent *event)
{
...
void computer1::on_pushButton_3_clicked()
{
    if(passwd1_count%2 == 1)
...
void computer1::on_pushButton_4_clicked()
{
    if(passwd2_count%2 == 1)
...
void computer1::on_pushButton_2_clicked()
{
    int a;
    a=link();
    widget->hide();
...
void computer1::on_pushButton_clicked()
{
    widget->hide();
    ui->lineEdit->clear();          //清空链接对话框里面的内容
    ui->lineEdit_2->clear();
