...
QT_MOC_LITERAL(7, 98, 23)
    ...
    "Dialog1\0signal2\0\0lineEdit_2\0"
...
void Dialog1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Dialog1::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Dialog1::signal2)) {
                *result = 0;
            }
        }
    }
